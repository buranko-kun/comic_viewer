...
/// Application-level source opener.
///
/// Reader state and behavior live in ReaderSession. AppModel remains intentionally small: it
/// decides how a user-provided URL is opened and keeps the existing public API used by the UI,
/// commands and headless tests.
@MainActor
@Observable
